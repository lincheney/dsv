...
_shtab__dsv_commands() {
  local _commands=(
    ...
    "set-header:set the header labels"
    "sort:sort the rows"
...
_shtab__dsv_join_options=(
  ...
  "--inner[do a inner join]"
  "--left[do a left join]"
  "--right[do a right join]"
  "--outer[do a outer join]"
  {-H,--header}"[treat first row as a header]"
  {-N,--no-header}"[do not treat first row as header]"
  "--drop-header[do not print the header]"
  "--trailer[print a trailer]:trailer:(never always auto)"
...
_shtab__dsv_py_options=(
  ...
  "--no-na[do not auto generate NA for invalid operations]"
...
_shtab__dsv_py_groupby_options=(
  ...
  {-x,--complement}"[exclude, rather than include, field names]"
  {-r,--regex}"[treat fields as regexes]"
  {-p,--python-fields}"[grouping fields are python scripts]"
  {-I,--ignore-errors}"[do not abort on python errors]"
  {-E,--remove-errors}"[remove rows on python errors]"
  {-H,--header}"[treat first row as a header]"
  {-N,--no-header}"[do not treat first row as header]"
...
_shtab__dsv_summary_options=(
  ...
  {-x,--complement}"[exclude, rather than include, field names]"
  {-r,--regex}"[treat fields as regexes]"
  "*"{-t,--type}"[assume field A is of type B]:type:"
  {-H,--header}"[treat first row as a header]"
  {-N,--no-header}"[do not treat first row as header]"
  "--drop-header[do not print the header]"
  "--trailer[print a trailer]:trailer:(never always auto)"
...
_shtab__dsv_uniq_options=(
  ...
  "--repeated-all[print all duplicate lines]"
  {-H,--header}"[treat first row as a header]"
  {-N,--no-header}"[do not treat first row as header]"
  "--drop-header[do not print the header]"
  "--trailer[print a trailer]:trailer:(never always auto)"
  ...
  case $state in
    dsv)
      ...
      case $line[1] in
        ...
        fromhtml) _arguments -C -s $_shtab__dsv_fromhtml_options ;;
        ...
        py) _arguments -C -s $_shtab__dsv_py_options ;;
        py-filter) _arguments -C -s $_shtab__dsv_py_filter_options ;;
        py-groupby) _arguments -C -s $_shtab__dsv_py_groupby_options ;;
